...
import DetailHeadings from './DetailHeadings';


function ReplyThreads({ comment, replies, relevant_shelterEmail }) {
    ...
    return (
        <div>
            ...
            <DetailHeadings text={'Reply'}/>

            {replies.map(reply => {
                const { replyClass, replyText } = getReplyType(reply);
                
                return (
                    <div key={reply.id} className="darker d-flex flex-start justify-content-center col-lg-12 mt-4">
