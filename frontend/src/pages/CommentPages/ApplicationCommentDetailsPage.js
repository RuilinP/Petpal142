...
function ApplicationCommentDetails() {
    const { applicationId, commentId } = useParams();
                ...
                <section id="reviews" className="my-5">
                    ...
                    <div className="container">
                        <div id="reviewBody" className="row d-flex justify-content-center">
                            ...
                            <LeaveReplyBox applicationId={applicationId} commentId={commentId} />
                            <ReplyList commentId={commentId} applicationId={applicationId}/>
...
export default ApplicationCommentDetails;
